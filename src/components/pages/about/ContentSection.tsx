    ...
    <div className="space-y-16 sm:space-y-24 lg:space-y-32">
      <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center text-left">
        ...
        >
          ...
          <div className="flex flex-col gap-3 sm:gap-4 relative z-10">
            {[
              ...
              <div
                key={item}
                className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:border-primary/20 transition-all group/item animate-fadeIn"
                style={{ 
        ...
        <div 
          ...
          className={`relative aspect-square rounded-2xl sm:rounded-[3rem] overflow-hidden border border-white/10 group transition-all duration-700 ${isInView2 ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}
          style={{ willChange: 'transform, opacity' }}
        >
      ...
      <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center text-left">
        <div 
          ...
          className={`relative aspect-video rounded-2xl sm:rounded-[3rem] overflow-hidden border border-white/10 order-2 lg:order-1 group transition-all duration-700 ${isInView3 ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}
          style={{ willChange: 'transform, opacity' }}
        >
        ...
        >
          ...
          <button className="relative z-10 px-6 sm:px-10 py-4 sm:py-5 bg-white text-black font-black rounded-xl sm:rounded-2xl uppercase tracking-widest text-xs hover:scale-105 active:scale-95 transition-transform shadow-[0_0_30px_rgba(255,255,255,0.1)]">
