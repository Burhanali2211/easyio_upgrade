...
const InnovationHub = memo(({ items = [] }: InnovationHubProps) => {
  ...
  return (
    <section className="py-16 sm:py-24 lg:py-32 relative bg-[#050505] z-10" data-section="innovation-hub">
      <div className="container relative z-10">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-12 sm:mb-16 lg:mb-20 gap-6 sm:gap-8">
          <div className="max-w-2xl">
            ...
            <h2 className="text-3xl sm:text-5xl lg:text-7xl font-display font-bold text-white tracking-tighter animate-fadeIn">
              Beyond Just <br />
          ...
          {displayedItems.map((item, index) => {
            ...
            return (
              <div
                ...
                className="group relative p-4 sm:p-6 lg:p-8 rounded-xl sm:rounded-[2rem] bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] hover:border-white/10 hover:shadow-[0_0_20px_rgba(255,255,255,0.05)] transition-all duration-300 overflow-hidden animate-fadeIn"
              >
                <div className="absolute top-0 right-0 p-4 sm:p-8 opacity-10 group-hover:opacity-20 transition-opacity duration-300">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-base sm:text-xl lg:text-2xl font-display font-bold text-white mb-2 sm:mb-4 group-hover:text-accent transition-colors duration-300">
                    {item.title}
                  </h3>
                  ...
                  <div className="pt-3 sm:pt-6 border-t border-white/5 flex items-center justify-between">
                    <span className="text-[8px] sm:text-[10px] font-mono text-white/40 uppercase tracking-tighter">Metric</span>
