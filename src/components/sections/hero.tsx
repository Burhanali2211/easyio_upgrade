      ...
      <div className="relative z-20 w-full min-h-screen flex items-center justify-center py-20 sm:py-24 lg:py-0">
        <div className="container relative z-20 pt-16 sm:pt-20 lg:pt-0">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <motion.div 
              className="flex flex-col space-y-6 sm:space-y-10 relative z-30"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.6 }}
            >
              <motion.div 
                className="inline-flex items-center space-x-2 sm:space-x-3 px-3 sm:px-4 py-2 rounded-xl sm:rounded-2xl bg-muted/50 dark:bg-white/[0.03] border border-border dark:border-white/10 w-fit backdrop-blur-md"
              ...
              <div className="space-y-4 sm:space-y-6">
                <motion.h1 
                  className="text-foreground leading-[0.8] tracking-[-0.07em] font-display text-[clamp(3rem,13vw,5.5rem)] lg:text-[clamp(4.5rem,9vw,7.5rem)] xl:text-[clamp(5.5rem,11vw,11rem)] font-black uppercase"
                ...
                <motion.p 
                  className="text-sm sm:text-lg lg:text-xl text-muted-foreground max-w-xl leading-relaxed font-medium"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
              ...
              <motion.div 
                className="grid grid-cols-3 gap-2 sm:gap-4 md:gap-6 lg:gap-8 xl:gap-12 pt-6 sm:pt-8 md:pt-10 lg:pt-12 border-t border-border dark:border-white/10"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.8 }}
              >
                <motion.div 
                  className="space-y-1 sm:space-y-1 md:space-y-1.5 lg:space-y-2"
