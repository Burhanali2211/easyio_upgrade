  ...
  return (
    ...
    >
      ...
      <div className="grid gap-1.5">
        {payload.map((item: { name?: string; value?: number | string; dataKey?: string; color?: string; payload?: Record<string, unknown>; fill?: string }, index: number) => {
...
function ChartLegendContent({
  ...
  return (
    ...
    >
      {payload.map((item: { value?: string; dataKey?: string; color?: string; type?: string }) => {
